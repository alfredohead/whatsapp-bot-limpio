...
RUN deluser nodeuser || true && \
    delgroup nodeuser || true && \
    addgroup --gid 1001 nodeuser && \
    adduser --system --uid 1001 --ingroup nodeuser --home /home/nodeuser --shell /bin/bash nodeuser
